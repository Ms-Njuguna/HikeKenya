...
function UserInfo({ name, email, points }) {
    return (
        <div className="border border-amber-700 rounded-[8px] mt-[70px] max-w-[1000px] mx-auto"> 
           <h3 className="text-xl font-serif text-[#D4AF37] tracking-wide text-center mt-[10px]">User Info</h3>
